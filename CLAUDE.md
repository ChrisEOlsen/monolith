...
**Fragment cache:** Every GET endpoint generated by `create_internal_api` is automatically wrapped in a Redis fragment cache (5 min TTL, keyed by `REQUEST_URI`). Do not add a second cache layer.
