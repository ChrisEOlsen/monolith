...
<body class="bg-zinc-950 text-zinc-100 font-sans min-h-screen flex flex-col selection:bg-indigo-500/30">
    ...
    <main class="flex-1 flex flex-col items-center justify-center text-center px-6 pt-32 pb-20">
        <div class="max-w-3xl">
            ...
            <h1 class="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-b from-white via-zinc-100 to-zinc-400 bg-clip-text text-transparent">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full px-4">
            ...
            <div class="group relative bg-zinc-950 border border-zinc-900 rounded-2xl p-8 flex flex-col items-center justify-center text-center opacity-50">
                <div class="w-12 h-12 bg-zinc-900 rounded-xl flex items-center justify-center mb-4 border border-zinc-800">
                    <span class="text-zinc-700 text-xl">+</span>
                </div>
                <h3 class="text-lg font-bold text-zinc-700">Coming Soon</h3>
                <p class="text-zinc-800 text-sm mt-2">Ask the AI to build something new.</p>
            </div>
        </div>
    </main>
